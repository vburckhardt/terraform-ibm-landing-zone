...
The landing zone module can be utilized to create a fully customizable VPC environment within a single region. The five following patterns serve as starting templates, allowing for a quick start with Landing Zone. These patterns are located in the [patterns](/patterns/) directory.

Each of these patterns (excluding VSI QuickStart) creates the following infrastructure:
